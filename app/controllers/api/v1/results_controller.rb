    ...
    def create
        ...
        if result.nil?
            ...
            if results.persisted?
               results_archieve = lab_order.create_result_archieve(patient_name: patient_full_name, blood_type: lab_order.blood_type, hiv_res: params[:hiv_res], tisuue_res: params[:tisuue_res], conducted_by: params[:conducted_by])
