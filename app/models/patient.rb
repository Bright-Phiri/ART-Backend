class Patient < ApplicationRecord
    ...
    validates :phone, uniqueness: true ,numericality: { only_integer: true}, format: {with: /\A(\+?(265|0){1}(1|88[0-9]|99[0-9]|98[0-9]|90[0-9]){1}[0-9]{7})\z/, message: ' number is invalid'}
